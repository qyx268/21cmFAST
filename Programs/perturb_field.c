...
#ifndef EVOLVE_DENSITY_LINEARLY
  if (BOX_LEN > DIM)
 ...
 * ************************************************************************* */
  ...
  //smooth the field
#ifndef EVOLVE_DENSITY_LINEARLY
#ifdef SMOOTH_EVOLVED_DENSITY_FIELD
  HII_filter(updated, 2, R_smooth_density*BOX_LEN/(float)HII_DIM);
#endif //SMOOTH_EVOLVED_DENSITY_FIELD
#endif //EVOLVE_DENSITY_LINEARLY
